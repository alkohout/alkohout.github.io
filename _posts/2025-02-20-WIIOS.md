...
<body>
    ...
    <section class="topics">
	  ...
	  While P.A.S. focused on hardware, software, and GUI development, I specialized in implementing <a href="https://alkohout.github.io/projects/waves-in-ice/WIIOS/wave_analysis/" target="_blank" >onboard wave analysis</a> algorithms to ensure precise data collection <a href="https://github.com/alkohout/waves-in-ice.git" target="_blank" >(GitHub)</a> <a href="https://www.cambridge.org/core/journals/annals-of-glaciology/article/device-for-measuring-waveinduced-motion-of-ice-floes-in-the-antarctic-marginal-ice-zone/BBFF5522226DC1383DAF210F7C8B9F61" target="_blank"> (Kohout <it> et. al. </it>, 2015).</a>
          <h5>Real-Time Spectral Analysis for Wave Motion Processing in Ice</h5>
	  ...
	  <h6>Data Acquisition & Preprocessing</h6>
          ...
          <h6>Automated Quality Control System</h6>
          ...
          <h6>Real-Time Processing Constraints</h6>
          <ul>
          ...
          <h6>Technical Skills Highlighted</h6>
          <ul>
