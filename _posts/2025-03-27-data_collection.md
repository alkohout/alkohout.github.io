...
Each WIIOS performed on-board data quality control and spectral analysis before returning the wave spectrum via satellite. </p>
        </div>
       </div>
    </section>
