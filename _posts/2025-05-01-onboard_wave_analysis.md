        ...
        <section class="topics">
            <div class="topic-list">
                <div class="topic inverse">
                    <h3>Real-Time Spectral Analysis for Wave Motion Processing</h3>
                    <p>The Waves-in-Ice project involves analyzing wave motion data using a custom-built C-based signal processing system. This system was designed to operate on resource-constrained hardware and provides real-time spectral analysis of wave data.</p>
